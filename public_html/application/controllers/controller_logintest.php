<?php
class Controller_Logintest extends Controller
{
    ...
    {		
		...
		$result = mysql_query("SELECT * FROM users WHERE login='$login'",$db); //извлекаем из базы все данные о пользователе с введенным логином
			...
			$this->view->generate('text_view.php', 'template_view.php', $data="Извините, введённый вами login или пароль неверный.");
			exit ();
			}
			else {
