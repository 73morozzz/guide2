				...
				<div class="container">
					<div class="row">
						<div class="col-sm-6">
							...
							<p>Забудь о нудных экскурсиях и толпах туристов, о потраченных деньгах и времени. Каждый зарегистрировавшийся может примерить на себя роль экскурсовода по джунглям своего города или напротив выступить в роли первооткрывателя новой локации.</p>
						</div> <!-- end .col-sm-6 -->
						<div class="col-sm-6">
				...
				<div class="container">
					...
					<div class="specialties-slider">
						...
						<div class="specialty">
							...
							<h5>Москва</h5>
							<p>Не только столица, но и важный туристический центр России. А международным деловым центром является “Москва-сити”</p>
						</div> <!-- end .specialty -->
						<div class="specialty">
							<div class="image">
							...
							<h5>Ульяновск</h5>
							<p>Президентский мост является самым длинным мостом России и одним из самых длинных мостов в Европе</p>
						</div> <!-- end .specialty -->
