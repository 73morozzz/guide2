			...
			<div class="inner">
				<div class="container">
					<div class="row aligned-cols">
						...
						<div class="col-sm-9">
							<p>Если вы собираетесь в путешествие в новый для вас город и не знаете, куда пойти и что посетить, то наш сервис именно для вас. Найдите здесь своего личного гида, который расскажет и покажет вам город, так, как никто его не видел. Этот гид - простой человек, живущий в этом городе, такую роль можете взять на себя и вы!
							</p>
						</div> <!-- end .col-sm-9 -->
					</div> <!-- end .row -->
				</div> <!-- end .container -->
		...
		<div class="section white">
			<div class="inner">
				<div class="container">
					<div class="row">
						<div class="col-sm-6">
							<h2><small>Выйдите из зоны комфорта </small>Путешествуйте</h2>
							...
							<p>Любой город, любая страна, когда-то бывшая неизвествой и негостеиприимной станет вашим вторым домом. Забудьте о бумажных картах и путеводителях, ведь с вами есть я, сервис, который поможет вам найти проводника по самым извилистым улочкам нового города. </p>
						</div> <!-- end .col-sm-6 -->
						<div class="col-sm-6">
